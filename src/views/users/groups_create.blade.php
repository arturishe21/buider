...
<script>
    ...
    <?php
    $total = 1;
    $permissions = \Config::get('builder::users.permissions', array());
...
<div class="widget-body no-padding">
    <div class="widget-body no-padding" style="margin: -10px;">
       <form id="group-create-form" method="post" class="smart-form" autocomplete="off" action="{{ url(\Config::get('builder::admin.uri') .'/tb/users/do-create') }}">
            <fieldset> 
            <div class="row">
            ...
            <footer>
            <a href="{{ url(\Config::get('builder::admin.uri') .'/tb/groups') }}">

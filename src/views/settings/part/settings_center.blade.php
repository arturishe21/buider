 ...
 <!-- MAIN CONTENT -->
             ...
             <div class="jarviswidget jarviswidget-color-blue " id="wid-id-4" data-widget-editbutton="false" data-widget-colorbutton="false">
                            <header>
                             ...
                             <div class="table_center no-padding">
                                      @include("builder::settings.part.table_center")
                             </div>
              </div>
        </div>
    ...
    <div id="modal_wrapper">
       @include("builder::settings.part.pop_settings_add")
    </div>
    <link rel="stylesheet" type="text/css" media="screen" href="{{asset('packages/vis/builder/css/settings.css')}}">
    <script src="{{asset('packages/vis/builder/js/settings.js')}}"></script>

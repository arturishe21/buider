...
class Translate
{
    ...
    public static function getInstance()
    {
        if (is_null(self::$instance)) {
            self::$instance = new self(\Config::get('builder::translate.locales'));
        }
    ...
    {
        $isAutotranslate = \Config::get('builder::translate.is_auto_translate');

        return $isAutotranslate; //  && (\Config::get('builder::translate.auto_translate_from') != $locale)
    } // end
